<?php
    ...
    $link = "https://api.fortnitetracker.com/v1/profile/pc/$name_asten";
    $ch = curl_init();
    ...
    curl_close($ch);
    $fp = fopen("../json/asten.json", "w");
    fwrite($fp, $response);
    fclose($fp);
    
    $data = json_decode(file_get_contents("../json/asten.json"));
    ...
    $req = $bdd->prepare('UPDATE fortnite SET kills = :nb_kills, win = :nb_wins, kda = :nb_kda, pseudo = :pseudo WHERE id = 2');
    $req->execute(array(
