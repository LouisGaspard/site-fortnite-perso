<?php
    ...
    $link = "https://api.fortnitetracker.com/v1/profile/pc/$name_ezhze";
    $ch = curl_init();
    ...
    curl_close($ch);
    $fp = fopen("../json/ezhze.json", "w");
    fwrite($fp, $response);
    fclose($fp);
    
    $data = json_decode(file_get_contents("../json/ezhze.json"));
    ...
    $req = $bdd->prepare('UPDATE fortnite SET kills = :nb_kills, win = :nb_wins, kda = :nb_kda, pseudo = :pseudo WHERE id = 3');
    $req->execute(array(
